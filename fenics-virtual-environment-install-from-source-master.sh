...
VENV_PATH="/home/jason_mulderrig/research/projects/composite-uFJC-diffuse-chain-scission"
...
pip3 install numpy==1.21.6 scipy mpmath sympy matplotlib pynverse composite-ufjc-scission-ufl-fenics==1.3.7
pip3 install mpi4py
