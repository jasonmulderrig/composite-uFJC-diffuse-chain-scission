...
class TwoDimensionalPlaneStrainNearlyIncompressibleNonaffineEightChainModelEqualStrainRateIndependentCavitation(CompositeuFJCDiffuseChainScissionProblem):

    def __init__(self, L, H, r_cavity, near_cavity_elem_size=0.001, far_cavity_elem_size=0.1, l_nl=0.1):
    ...
    def set_fenics_weak_form_deformation_finalization(self): # incomplete
        """
        ...
        if ppp.save_lmbda_c_tilde_chunks:
            ...
            for meshpoint_indx in range(len(gp.meshpoints)):
                lmbda_c_tilde___meshpoint_chunk = [lmbda_c_tilde_chunk[meshpoint_indx] for lmbda_c_tilde_chunk in weak_form_chunks.lmbda_c_tilde_chunks]
                plt.plot(deformation.u_r_chunks, lmbda_c_tilde___meshpoint_chunk, linestyle='-', color=gp.meshpoints_color_list[meshpoint_indx], alpha=1, linewidth=2.5, label=gp.meshpoints_label_list[meshpoint_indx])
            plt.legend(loc='best')
            plt.grid(True, alpha=0.25)
            save_current_figure(self.savedir, r'$u_r$', 30, r'$\tilde{\lambda}_c$', 30, "fenics-weak-form-uniaxial-rate-independent-u_r-vs-lmbda_c_tilde")
        ...
        if ppp.save_lmbda_c_eq_tilde_chunks:
            ...
            for meshpoint_indx in range(len(gp.meshpoints)):
                ...
                for nu_chunk_indx in range(len(mp.nu_chunks_list)):
                    lmbda_c_eq_tilde___nu_chunk = [lmbda_c_eq_tilde_chunk[nu_chunk_indx] for lmbda_c_eq_tilde_chunk in lmbda_c_eq_tilde___meshpoint_chunk]
                    plt.plot(deformation.u_r_chunks, lmbda_c_eq_tilde___nu_chunk, linestyle='-', color=mp.nu_chunks_color_list[nu_chunk_indx], alpha=1, linewidth=2.5, label=mp.nu_chunks_label_list[nu_chunk_indx])
                plt.legend(loc='best')
                plt.grid(True, alpha=0.25)
                save_current_figure(self.savedir, r'$u_r$', 30, r'$\tilde{\lambda}_c^{eq}$', 30, "fenics-weak-form-uniaxial-rate-independent-u_r-vs-lmbda_c_eq_tilde"+"_"+gp.meshpoints_name_list[meshpoint_indx])
        ...
        if ppp.save_lmbda_nu_tilde_chunks:
            ...
            for meshpoint_indx in range(len(gp.meshpoints)):
                ...
                for nu_chunk_indx in range(len(mp.nu_chunks_list)):
                    lmbda_nu_tilde___nu_chunk = [lmbda_nu_tilde_chunk[nu_chunk_indx] for lmbda_nu_tilde_chunk in lmbda_nu_tilde___meshpoint_chunk]
                    plt.plot(deformation.u_r_chunks, lmbda_nu_tilde___nu_chunk, linestyle='-', color=mp.nu_chunks_color_list[nu_chunk_indx], alpha=1, linewidth=2.5, label=mp.nu_chunks_label_list[nu_chunk_indx])
                plt.legend(loc='best')
                plt.grid(True, alpha=0.25)
                save_current_figure(self.savedir, r'$u_r$', 30, r'$\tilde{\lambda}_{\nu}$', 30, "fenics-weak-form-uniaxial-rate-independent-u_r-vs-lmbda_nu_tilde"+"_"+gp.meshpoints_name_list[meshpoint_indx])
        ...
        if ppp.save_epsilon_cnu_diss_hat_chunks:
            ...
            for meshpoint_indx in range(len(gp.meshpoints)):
                ...
                for nu_chunk_indx in range(len(mp.nu_chunks_list)):
                    epsilon_cnu_diss_hat___nu_chunk = [epsilon_cnu_diss_hat_chunk[nu_chunk_indx] for epsilon_cnu_diss_hat_chunk in epsilon_cnu_diss_hat___meshpoint_chunk]
                    plt.plot(deformation.u_r_chunks, epsilon_cnu_diss_hat___nu_chunk, linestyle='-', color=mp.nu_chunks_color_list[nu_chunk_indx], alpha=1, linewidth=2.5, label=mp.nu_chunks_label_list[nu_chunk_indx])
                plt.legend(loc='best')
                plt.grid(True, alpha=0.25)
                save_current_figure(self.savedir, r'$u_r$', 30, r'$\hat{\varepsilon}_{c\nu}^{diss}$', 30, "fenics-weak-form-uniaxial-rate-independent-u_r-vs-epsilon_cnu_diss_hat"+"_"+gp.meshpoints_name_list[meshpoint_indx])
        ...
        if ppp.save_Epsilon_cnu_diss_hat_chunks:
            ...
            for meshpoint_indx in range(len(gp.meshpoints)):
                Epsilon_cnu_diss_hat___meshpoint_chunk = [Epsilon_cnu_diss_hat_chunk[meshpoint_indx] for Epsilon_cnu_diss_hat_chunk in weak_form_chunks.Epsilon_cnu_diss_hat_chunks]
                plt.plot(deformation.u_r_chunks, Epsilon_cnu_diss_hat___meshpoint_chunk, linestyle='-', color=gp.meshpoints_color_list[meshpoint_indx], alpha=1, linewidth=2.5, label=gp.meshpoints_label_list[meshpoint_indx])
            plt.legend(loc='best')
            plt.grid(True, alpha=0.25)
            save_current_figure(self.savedir, r'$u_r$', 30, r'$\hat{E}_{c\nu}^{diss}$', 30, "fenics-weak-form-uniaxial-rate-independent-u_r-vs-Epsilon_cnu_diss_hat")
        ...
        if ppp.save_epsilon_c_diss_hat_chunks:
            ...
            for meshpoint_indx in range(len(gp.meshpoints)):
                ...
                for nu_chunk_indx in range(len(mp.nu_chunks_list)):
                    epsilon_c_diss_hat___nu_chunk = [epsilon_c_diss_hat_chunk[nu_chunk_indx] for epsilon_c_diss_hat_chunk in epsilon_c_diss_hat___meshpoint_chunk]
                    plt.plot(deformation.u_r_chunks, epsilon_c_diss_hat___nu_chunk, linestyle='-', color=mp.nu_chunks_color_list[nu_chunk_indx], alpha=1, linewidth=2.5, label=mp.nu_chunks_label_list[nu_chunk_indx])
                plt.legend(loc='best')
                plt.grid(True, alpha=0.25)
                save_current_figure(self.savedir, r'$u_r$', 30, r'$\hat{\varepsilon}_c^{diss}$', 30, "fenics-weak-form-uniaxial-rate-independent-u_r-vs-epsilon_c_diss_hat"+"_"+gp.meshpoints_name_list[meshpoint_indx])
        ...
        if ppp.save_Epsilon_c_diss_hat_chunks:
            ...
            for meshpoint_indx in range(len(gp.meshpoints)):
                Epsilon_c_diss_hat___meshpoint_chunk = [Epsilon_c_diss_hat_chunk[meshpoint_indx] for Epsilon_c_diss_hat_chunk in weak_form_chunks.Epsilon_c_diss_hat_chunks]
                plt.plot(deformation.u_r_chunks, Epsilon_c_diss_hat___meshpoint_chunk, linestyle='-', color=gp.meshpoints_color_list[meshpoint_indx], alpha=1, linewidth=2.5, label=gp.meshpoints_label_list[meshpoint_indx])
            plt.legend(loc='best')
            plt.grid(True, alpha=0.25)
            save_current_figure(self.savedir, r'$u_r$', 30, r'$\hat{E}_c^{diss}$', 30, "fenics-weak-form-uniaxial-rate-independent-u_r-vs-Epsilon_c_diss_hat")
        ...
        if ppp.save_overline_epsilon_cnu_diss_hat_chunks:
            ...
            for meshpoint_indx in range(len(gp.meshpoints)):
                ...
                for nu_chunk_indx in range(len(mp.nu_chunks_list)):
                    overline_epsilon_cnu_diss_hat___nu_chunk = [overline_epsilon_cnu_diss_hat_chunk[nu_chunk_indx] for overline_epsilon_cnu_diss_hat_chunk in overline_epsilon_cnu_diss_hat___meshpoint_chunk]
                    plt.plot(deformation.u_r_chunks, overline_epsilon_cnu_diss_hat___nu_chunk, linestyle='-', color=mp.nu_chunks_color_list[nu_chunk_indx], alpha=1, linewidth=2.5, label=mp.nu_chunks_label_list[nu_chunk_indx])
                plt.legend(loc='best')
                plt.grid(True, alpha=0.25)
                save_current_figure(self.savedir, r'$u_r$', 30, r'$\overline{\hat{\varepsilon}_{c\nu}^{diss}}$', 30, "fenics-weak-form-uniaxial-rate-independent-u_r-vs-overline_epsilon_cnu_diss_hat"+"_"+gp.meshpoints_name_list[meshpoint_indx])
        ...
        if ppp.save_overline_Epsilon_cnu_diss_hat_chunks:
            ...
            for meshpoint_indx in range(len(gp.meshpoints)):
                overline_Epsilon_cnu_diss_hat___meshpoint_chunk = [overline_Epsilon_cnu_diss_hat_chunk[meshpoint_indx] for overline_Epsilon_cnu_diss_hat_chunk in weak_form_chunks.overline_Epsilon_cnu_diss_hat_chunks]
                plt.plot(deformation.u_r_chunks, overline_Epsilon_cnu_diss_hat___meshpoint_chunk, linestyle='-', color=gp.meshpoints_color_list[meshpoint_indx], alpha=1, linewidth=2.5, label=gp.meshpoints_label_list[meshpoint_indx])
            plt.legend(loc='best')
            plt.grid(True, alpha=0.25)
            save_current_figure(self.savedir, r'$u_r$', 30, r'$\overline{\hat{E}_{c\nu}^{diss}}$', 30, "fenics-weak-form-uniaxial-rate-independent-u_r-vs-overline_Epsilon_cnu_diss_hat")
        ...
        if ppp.save_overline_epsilon_c_diss_hat_chunks:
            ...
            for meshpoint_indx in range(len(gp.meshpoints)):
                ...
                for nu_chunk_indx in range(len(mp.nu_chunks_list)):
                    overline_epsilon_c_diss_hat___nu_chunk = [overline_epsilon_c_diss_hat_chunk[nu_chunk_indx] for overline_epsilon_c_diss_hat_chunk in overline_epsilon_c_diss_hat___meshpoint_chunk]
                    plt.plot(deformation.u_r_chunks, overline_epsilon_c_diss_hat___nu_chunk, linestyle='-', color=mp.nu_chunks_color_list[nu_chunk_indx], alpha=1, linewidth=2.5, label=mp.nu_chunks_label_list[nu_chunk_indx])
                plt.legend(loc='best')
                plt.grid(True, alpha=0.25)
                save_current_figure(self.savedir, r'$u_r$', 30, r'$\overline{\hat{\varepsilon}_c^{diss}}$', 30, "fenics-weak-form-uniaxial-rate-independent-u_r-vs-overline_epsilon_c_diss_hat"+"_"+gp.meshpoints_name_list[meshpoint_indx])
        ...
        if ppp.save_overline_Epsilon_c_diss_hat_chunks:
            ...
            for meshpoint_indx in range(len(gp.meshpoints)):
                overline_Epsilon_c_diss_hat___meshpoint_chunk = [overline_Epsilon_c_diss_hat_chunk[meshpoint_indx] for overline_Epsilon_c_diss_hat_chunk in weak_form_chunks.overline_Epsilon_c_diss_hat_chunks]
                plt.plot(deformation.u_r_chunks, overline_Epsilon_c_diss_hat___meshpoint_chunk, linestyle='-', color=gp.meshpoints_color_list[meshpoint_indx], alpha=1, linewidth=2.5, label=gp.meshpoints_label_list[meshpoint_indx])
            plt.legend(loc='best')
            plt.grid(True, alpha=0.25)
            save_current_figure(self.savedir, r'$u_r$', 30, r'$\overline{\hat{E}_c^{diss}}$', 30, "fenics-weak-form-uniaxial-rate-independent-u_r-vs-overline_Epsilon_c_diss_hat")
...
if __name__ == '__main__':
    ...
    l_nl = far_cavity_elem_size
    problem = TwoDimensionalPlaneStrainNearlyIncompressibleNonaffineEightChainModelEqualStrainRateIndependentCavitation(L, H, r_cavity, near_cavity_elem_size, far_cavity_elem_size, l_nl)
