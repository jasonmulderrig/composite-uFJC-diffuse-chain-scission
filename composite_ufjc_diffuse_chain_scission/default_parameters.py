...
def default_material_parameters():
    ...
    scission_model = "analytical"
    lmbda_nu_crit_min = None
    lmbda_nu_crit_max = None
    tau            = None
    lmbda_nu_check = None

    material.scission_model = scission_model
    material.lmbda_nu_crit_min = lmbda_nu_crit_min
    material.lmbda_nu_crit_max = lmbda_nu_crit_max
    material.tau = tau
    material.lmbda_nu_check = lmbda_nu_check
    ...
    microcircle_quadrature_order       = 1
    ...
    material.microcircle_quadrature_order       = microcircle_quadrature_order
...
def default_post_processing_parameters():
    ...
    save_epsilon_cnu_diss_hat_mesh            = False
    save_epsilon_cnu_diss_hat_chunks          = False
    save_Epsilon_cnu_diss_hat_mesh            = False
    save_Epsilon_cnu_diss_hat_chunks          = False
    save_epsilon_c_diss_hat_mesh              = False
    save_epsilon_c_diss_hat_chunks            = False
    save_Epsilon_c_diss_hat_mesh              = False
    save_Epsilon_c_diss_hat_chunks            = False
    save_overline_epsilon_cnu_diss_hat_mesh   = False
    save_overline_epsilon_cnu_diss_hat_chunks = False
    save_overline_Epsilon_cnu_diss_hat_mesh   = False
    save_overline_Epsilon_cnu_diss_hat_chunks = False
    save_overline_epsilon_c_diss_hat_mesh     = False
    save_overline_epsilon_c_diss_hat_chunks   = False
    save_overline_Epsilon_c_diss_hat_mesh     = False
    save_overline_Epsilon_c_diss_hat_chunks   = False
    ...
    post_processing.save_D_c_mesh                             = save_D_c_mesh
    post_processing.save_D_c_chunks                           = save_D_c_chunks
    post_processing.save_epsilon_cnu_diss_hat_mesh            = save_epsilon_cnu_diss_hat_mesh
    post_processing.save_epsilon_cnu_diss_hat_chunks          = save_epsilon_cnu_diss_hat_chunks
    post_processing.save_Epsilon_cnu_diss_hat_mesh            = save_Epsilon_cnu_diss_hat_mesh
    post_processing.save_Epsilon_cnu_diss_hat_chunks          = save_Epsilon_cnu_diss_hat_chunks
    post_processing.save_epsilon_c_diss_hat_mesh              = save_epsilon_c_diss_hat_mesh
    post_processing.save_epsilon_c_diss_hat_chunks            = save_epsilon_c_diss_hat_chunks
    post_processing.save_Epsilon_c_diss_hat_mesh              = save_Epsilon_c_diss_hat_mesh
    post_processing.save_Epsilon_c_diss_hat_chunks            = save_Epsilon_c_diss_hat_chunks
    post_processing.save_overline_epsilon_cnu_diss_hat_mesh   = save_overline_epsilon_cnu_diss_hat_mesh
    post_processing.save_overline_epsilon_cnu_diss_hat_chunks = save_overline_epsilon_cnu_diss_hat_chunks
    post_processing.save_overline_Epsilon_cnu_diss_hat_mesh   = save_overline_Epsilon_cnu_diss_hat_mesh
    post_processing.save_overline_Epsilon_cnu_diss_hat_chunks = save_overline_Epsilon_cnu_diss_hat_chunks
    post_processing.save_overline_epsilon_c_diss_hat_mesh     = save_overline_epsilon_c_diss_hat_mesh
    post_processing.save_overline_epsilon_c_diss_hat_chunks   = save_overline_epsilon_c_diss_hat_chunks
    post_processing.save_overline_Epsilon_c_diss_hat_mesh     = save_overline_Epsilon_c_diss_hat_mesh
    post_processing.save_overline_Epsilon_c_diss_hat_chunks   = save_overline_Epsilon_c_diss_hat_chunks
